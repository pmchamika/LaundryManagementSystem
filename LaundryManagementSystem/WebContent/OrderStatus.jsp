...
<link rel="stylesheet" type="text/css" href="deleteOrder-style.css"/>
<script type="text/javascript" src="deleteOrder-validate.js">
</script>
<title></title>
</head>
<body>
<div class="main">
		...
		<div>
			...
			<form name="myForms" method="POST" onsubmit="return formValidation()" action="OrderStatus">
			...
			<tr style=height:50px;></tr>
				...
				<input type="submit" value="Check Status" class="delete-button" style="width:140px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:0px;margin-left:200px;"/>
			...
			if((id!=null)&&(nic!=null)&(days!=null)){
				...
				out.write("<h1 style='margin-left:220px;margin-top:80px;color:#001b2d;'><pre>Remaining Time(Days): "+days+"</pre></h1>");
