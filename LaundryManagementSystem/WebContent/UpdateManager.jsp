...
<link rel="stylesheet" type="text/css" href="updateManager-style.css"/>
<script type="text/javascript" src="updateManager-validate.js">
</script>
<title></title>
</head>
<body>
<div class="main">
		...
		<div>
				...
				<form name="myForms" method="POST" onsubmit="return formValidation()" action="UpdateManager">
				<table style="margin-left:100px;padding-top:30px;">
			
			<tr>
					<td>Full Name:</td>
					<td><input type="text" name="fname" style="width:364px; height:30px;padding-left:16px;border-radius:5px;margin-left:55px;"/></td>
			</tr>
			...
			<tr style=height:50px;></tr>
				...
				<input type="submit" value="Update Manager" class="add-button" style="width:140px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:0px;margin-left:200px;"/>
