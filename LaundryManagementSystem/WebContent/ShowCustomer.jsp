...
<link rel="stylesheet" type="text/css" href="showCustomer-style.css"/>
<script type="text/javascript" src="showCustomer-validate.js">
</script>
<title></title>
</head>
<body>
<div class="main">
		...
		<div>
			...
			<form name="myForms" method="POST" onsubmit="return formValidation()" action="ShowCustomer">
				<table style="margin-left:100px;padding-top:30px;">
				
			<tr>
				<td>Customer NIC:</td>
				<td><input type="text" name="nic" style="width:364px; height:30px;padding-left:16px;border-radius:5px;margin-left:55px;"/></td>
			</tr>
			
			<tr style=height:50px;></tr>
			</table>
				<input type="submit" value="View Customer" class="show-button" style="width:140px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:0px;margin-left:200px;"/>
			...
			if((name!=null)&&(address!=null)&&(nic!=null)&&(phone!=null)){
				out.write("<h1 style='margin-left:220px;margin-top:80px;color:#001b2d;'><pre>Customer Name:      "+name+"</pre></h1>");
				out.write("<h1 style='margin-left:220px;margin-top:80px;color:#001b2d;'><pre>Customer ID:        "+id+"</pre></h1>");
				...
				out.write("<h1 style='margin-left:220px;margin-top:80px;color:#001b2d;'><pre>Contact No:         "+phone+"</pre></h1>");
