...
<div class="main">
		...
		<div>
			...
			<form name="myForms" method="POST" onsubmit="return formValidation()" action="DeleteOrder">
			...
			<tr style=height:50px;></tr>
				...
				<input type="submit" value="Delete Order" class="delete-button" style="width:140px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:0px;margin-left:200px;"/>
