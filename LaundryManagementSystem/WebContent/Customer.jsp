...
<div class="main">
		...
		<div>
				...
				<table>
				<tr><td><input type="submit" value="Add Customer"  style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
				<form action="UpdateCustomer.jsp">
				<table>
				<tr><td><input type="submit" value="Update Customer" style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
				<form action="DeleteCustomer.jsp">
				<table>
				<tr><td><input type="submit" value="Delete Customer" style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
				<form action="ShowCustomer.jsp">
				<table>
				<tr><td><input type="submit" value="View Customer" style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
