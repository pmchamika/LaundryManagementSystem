...
<link rel="stylesheet" type="text/css" href="deleteCustomer-style.css"/>
<script type="text/javascript" src="deleteCustomer-validate.js">
</script>
<title></title>
</head>
<body>
<div class="main">
		...
		<div>
			...
			<form name="myForms" method="POST" onsubmit="return formValidation()" action="DeleteCustomer">
			...
			<tr style=height:50px;></tr>
				...
				<input type="submit" value="Delete Customer" class="delete-button" style="width:140px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:0px;margin-left:200px;"/>
