...
<div class="main">
		...
		<div>
				...
				<form action="UpdateManager.jsp">
				<table>
				<tr><td><input type="submit" value="Update Manager" style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
				<form action="ShowManager.jsp">
				<table>
				<tr><td><input type="submit" value="View Manager" style="width:200px;height:50px;background:linear-gradient(to bottom right, #1c4c89, #2282a3);color:white;border-radius:9px;margin-top:50px;margin-left:300px;"/></td></tr>
				</table>
				</form>
